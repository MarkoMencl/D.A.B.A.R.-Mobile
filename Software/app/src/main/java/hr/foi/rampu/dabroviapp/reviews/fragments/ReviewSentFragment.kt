...
class ReviewSentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_review_sent, container, false)

        recyclerView = view.findViewById(R.id.rv_review_sent)
    ...
    private fun fetchSentMessages(senderId: Int){
        val ws = WsReview.reviewService
        ws.getSenderReview(senderId).enqueue(object : Callback<List<Review>> {
